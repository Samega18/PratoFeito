...
import br.com.pratofeito.customer.domain.api.MarkCustomerOrderDeliveredCommand
...
internal class CustomerOrder {
    ...
    @CommandHandler
    fun handle(command: MarkCustomerOrderDeliveredCommand){
        if(CustomerOrderState.CREATED == state){
            ...
            throw UnsupportedOperationException("The currrent state is not CREATED")
        }
    }
